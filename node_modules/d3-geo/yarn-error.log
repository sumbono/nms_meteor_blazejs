Arguments: 
  /usr/local/Cellar/node/10.9.0/bin/node /usr/local/Cellar/yarn/1.9.4/libexec/bin/yarn.js publish

PATH: 
  /Library/Frameworks/Python.framework/Versions/3.6/bin:/Users/fil/miniconda3/bin:/usr/local/opt/gdal2/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/MacGPG2/bin:/opt/X11/bin:/usr/local/go/bin:/usr/local/sbin
