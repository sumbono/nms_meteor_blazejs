Template.transmitter.onRendered(function(){
    var template = Template.instance();
    // var dev_id  = $("span[data-valueMax]").data("data-valueMax");
    // var v_max   = $("span[data-valueMax]").data("data-valueMax");
    // $("#targetValue").text();
    // template.autorun(() => {
    //     template.subscribe("featured-sitelog", template.data);
    // })
})

Template.transmitter.events({
